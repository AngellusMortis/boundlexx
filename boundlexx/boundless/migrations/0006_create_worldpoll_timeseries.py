...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "SELECT create_hypertable('boundless_worldpollresult', 'time', chunk_time_interval => 86400000000, migrate_data => true, create_default_indexes => true)", reverse_sql=migrations.RunSQL.noop
        ),
        migrations.RunSQL(
            'ALTER TABLE "boundless_resourcecount" DROP CONSTRAINT "boundless_resourcecount_pkey"', reverse_sql=migrations.RunSQL.noop
        ),
        migrations.RunSQL(
            "SELECT create_hypertable('boundless_resourcecount', 'time', chunk_time_interval => 86400000000, migrate_data => true, create_default_indexes => true)", reverse_sql=migrations.RunSQL.noop
        ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            "SELECT create_hypertable('boundless_leaderboardrecord', 'time', chunk_time_interval => 86400000000, migrate_data => true, create_default_indexes => true)", reverse_sql=migrations.RunSQL.noop
        ),
    ]
