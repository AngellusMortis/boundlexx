...
AZURE_STATIC_CDN_PROFILE_NAME = env("AZURE_STATIC_CDN_PROFILE_NAME", default=None)
AZURE_STATIC_CDN_ENDPOINT_NAME = env("AZURE_STATIC_CDN_ENDPOINT_NAME", default=None)
