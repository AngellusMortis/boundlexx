...
from bge.api.schemas import DescriptiveAutoSchema
from bge.api.serializers import ColorSerializer, ItemSerializer
from bge.boundless.models import Color, Item
